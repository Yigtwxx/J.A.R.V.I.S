...
const StreamingMessageBubble = () => {
    ...
    // Render only once actual content starts streaming; the search loader covers the waiting state.
            ...
            <div className="w-full max-w-3xl space-y-6">
                <div className="message-bubble message-ai text-white font-mono text-[15px] leading-normal tracking-wide shadow-lg border-l-4 border-cyan-400 relative">
                    ...
                    <ReactMarkdown
                        components={{
                            p: ({ children, ...props }) => (
                                <p className="leading-normal text-gray-200 mb-2 last:mb-0" {...props}>
                                    {children}
                                </p>
                            ),
                        }}
