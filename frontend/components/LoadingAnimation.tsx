    ...
    return (
        <div className="flex flex-col items-center justify-center gap-7 py-4">
            ...
            <div className="relative w-28 h-28">
                ...
                />
                <motion.div
                    className="absolute inset-3 rounded-full border-2 border-transparent border-t-cyan-500 border-r-cyan-500/30"
                    animate={{ rotate: -360 }}
                    transition={{ duration: 2, repeat: Infinity, ease: 'linear' }}
                />
                <motion.div
                    className="absolute inset-7 rounded-full border border-transparent border-b-cyan-300 opacity-80"
                    animate={{ rotate: 360 }}
                ...
                {/* Center Core */}
                <motion.div
                    className="absolute inset-0 m-auto w-6 h-6 rounded-full bg-cyan-400"
                    animate={{
                        scale: [1, 1.1, 1],
                        opacity: [0.8, 1, 0.8],
                    }}
            ...
            <div className="flex flex-col items-center gap-2">
                ...
                {subText && (
                    <motion.p
                        ...
                        className="text-cyan-600 font-mono text-xs tracking-wider max-w-sm text-center truncate"
                    >
                        {subText}
                    </motion.p>
                )}
