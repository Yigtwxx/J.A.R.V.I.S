...
describe('api', () => {
    describe('axios instance creation', () => {
        it('creates axios with correct baseURL and no timeout', () => {
    ...
    describe('searchPerson', () => {
        it('posts to /api/search/ with query and depth, inheriting the untimed client', async () => {
        ...
        it('uses default depth of 5', async () => {
            ...
            expect(mock.post).toHaveBeenCalledWith('/api/search/', { query: 'test', depth: 5 }, expect.anything());
        });
    ...
    describe('export endpoints', () => {
        it('exportPdfFromData posts with responseType blob', async () => {
            ...
            expect(mock.post).toHaveBeenCalledWith('/api/export/pdf', profileData, { responseType: 'blob' });
        ...
        it('exportJsonFromData posts with responseType blob', async () => {
            ...
            expect(mock.post).toHaveBeenCalledWith('/api/export/json', expect.anything(), { responseType: 'blob' });
        });
        ...
        it('exportCsvFromData posts with responseType blob', async () => {
            ...
            expect(mock.post).toHaveBeenCalledWith('/api/export/csv', expect.anything(), { responseType: 'blob' });
        });
    });
